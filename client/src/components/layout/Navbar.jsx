      ...
      <div className="bg-white py-4">
        <div className="container mx-auto flex flex-wrap items-center justify-between px-4 gap-4">
          ...
          <div className="hidden lg:flex items-center space-x-6 text-gray-700 order-2 lg:order-3">
            ...
            {isAuthenticated && <button className=" flex items-center p-2 bg-red-50   rounded-lg shadow-sm hover:bg-red-100  transition duration-150 font-medium text-lg"> 
            <LogOut 
             onClick={() => {dispatch(logout()), window.location.reload();}}
               className="h-6 w-6    white cursor-pointer" />
            Logout
            </button>}
          </div>
